...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Query SQL untuk menambahkan produk baru
    $query = "INSERT INTO produk (nama_produk, stock_produk, harga_produk) VALUES (:nama_produk, :stock_produk, :harga_produk)";
    ...
    try {
        ...
        // Redirect kembali ke halaman view_produk setelah berhasil menambahkan produk
...
<body>
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
        ...
        <input type="text" id="stock_produk" name="stock_produk"><br>
